...
class StarRatings extends React.Component {
  constructor(props) {
    ...
    this.hoverOverStar = this.hoverOverStar.bind(this);
    this.unHoverOverStar = this.unHoverOverStar.bind(this);
  }
    ...
    return numberOfStarsArray.map((_, index) => {
      ...
      return (
        <Star
          ...
          hoverOverStar={changeRating ? () => _this.hoverOverStar(starRating) : null}
          unHoverOverStar={changeRating ? () => _this.unHoverOverStar() : null}
          isStarred={isStarred}
  ...
  render() {
    ...
    return (
      <div className="star-ratings" title={this.titleText} style={this.starRatingsStyle}>
