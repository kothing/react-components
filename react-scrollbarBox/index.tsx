...
export default class ScrollbarBox extends React.PureComponent<Props, State> {
  protected static displayName = 'ScrollbarBox';
  ...
  public render() {
    ...
    return (
      <div
        className={`ScrollbarBox ${this.props.className}`}
        style={{ ...this.props.style, ...(styles.main as React.CSSProperties) }}>
        <div
          className="ScrollbarBox-container"
        ...
        {this.state.showVeriticalTrack ? (
          <div
            className={`ScrollbarBox-vertical-track ${
            ...
            <div
              className={`ScrollbarBox-vertical-handler ${
        ...
        {this.state.showHorizontalTrack ? (
          <div
            className={`ScrollbarBox-horizontal-track ${
            ...
            <div
              className={`ScrollbarBox-horizontal-handler ${
